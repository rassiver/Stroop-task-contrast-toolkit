...
color_values = {
    "red": [0.95, 0.0, 0.0],     # Desaturated red
    "green": [0.0, 0.95, 0.0],   # Desaturated green
    "blue": [0.0, 0.0, 0.95],    # Desaturated blue
    "yellow": [0.95, 0.95, 0.0],  # Desaturated yellow
...
def create_stroop_stimulus(stimulus_code):
    ...
    text = visual.TextStim(
        ...
        opacity=0.05,  # Adjust this value (0.1-0.3) to control visibility
        height=80, 
        bold=True, 
        pos=[0, 0]
    )
