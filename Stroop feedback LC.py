...
win = visual.Window([800, 600], color=[0.2, 0.2, 0.2], units="pix", fullscr=True)

# Define DESATURATED color RGB values for text (background is constant gray)
color_values = {
    "red": [0.25, 0.18, 0.18],     # Desaturated red
    "green": [0.18, 0.25, 0.18],   # Desaturated green
    "blue": [0.18, 0.18, 0.25],    # Desaturated blue
    "yellow": [0.25, 0.25, 0.18],  # Desaturated yellow
    "neutral_bg": [0.2, 0.2, 0.2],  # Constant background
...
background = visual.Rect(
    ...
    fillColor=color_values["neutral_bg"],
    pos=(0, 0)
)
