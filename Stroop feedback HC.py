...
color_values = {
    "red": [1.0, -1.0, -1.0],    # Bright red
    "green": [-1.0, 1.0, -1.0],  # Bright green
    "blue": [-1.0, -1.0, 1.0],   # Bright blue
    "yellow": [1.0, 1.0, -1.0],  # Bright yellow
...
for block_type, block_num in block_sequence:
    if block_type == "congruent":
        ...
        send_event_code(outlet, 300, 'neutral_block_start')  # Fixed code
